...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.towingCapacity), parseInt(answers.topSpeed), []);
